...
<!-- 1)  users should be able to type a task into the input field -->
<!-- 2) users should be able to click some form of a submit button -->
3)  the task string that the user provided should appear on
